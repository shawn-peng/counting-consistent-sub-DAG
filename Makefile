...
graph_gen: graph_gen.o dag_generator.o dag.o random_device.o
	$(CC) -o $@ $^ $(CPPFLAGS)

batch_graph_gen: batch_graph_gen.o dag_generator.o dag.o graph_alg.cpp random_device.o
	$(CC) -o $@ $^ $(CPPFLAGS)

analyze_graph: analyze_graph.o dag_generator.o dag.o random_device.o
	$(CC) -o $@ $^ $(CPPFLAGS)
