...
result_file="experiments/pivots/prune_hash_degreepivot.csv"
detail_log_dir="experiments/pivots/prune_hash_degreepivot_details/"

alg_parameters="--prune --hash --pivot degree"
