...
result_file="experiments/pivots/prune_hash_boundpivot.csv"
detail_log_dir="experiments/pivots/prune_hash_boundpivot_details/"

alg_parameters="--prune --hash --pivot bound"
